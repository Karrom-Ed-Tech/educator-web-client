...
function Navbar() {
  ...
  return (
    <nav className="flex justify-between py-8 p-page items-center bg-white shadow-black-500/100">
      ...
      <div className={`flex-1 flex justify-center gap-x-12 ${!open && "mobile:hidden"} mobile:flex mobile:flex-col mobile:absolute mobile:w-11/12 mobile:top-24 mobile:gap-y-3 mobile:text-3xl mobile:py-10 mobile:px-5 mobile:bg-black mobile:text-white mobile:bg-opacity-80 rounded-bl-md`}>
  {navItems.map((item, i) => (
