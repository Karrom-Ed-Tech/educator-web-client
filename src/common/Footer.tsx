    ...
    <section className="p-page flex py-12 overflow-hidden relative mt-5 mobile:flex-col-reverse">
      ...
      <div className="basis-1/2">
        ...
        <div className="flex gap-x-6 my-3">
          <Link
            to="wa.me/8888888888"
            className="flex items-center bg-[#15b346] text-white px-8 py-3 text-lg rounded-md mobile:px-2 mobile:text-sm"
          >
            <img
          ...
          <Link
            ...
            className="flex items-center border-front border-2 border-opacity-20 duration-300 hover:border-opacity-100 px-8 py-3 text-lg rounded-md mobile:px-2 mobile:text-sm"
          >
