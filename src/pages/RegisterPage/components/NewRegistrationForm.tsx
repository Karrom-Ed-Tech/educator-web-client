...
export default function NewRegistrationForm(){
    ...
    return (
      <form className="min-h-[50vh] flex flex-col p-page py-12">
        ...
        We kindly request you to fill out the form provided. Once you submit the form, we will promptly get in touch with you to move forward with your inquiry. We're eager to assist you and address any questions or requirements you may have
        </div>
        ...
        <div className="flex justify-end p-5">
         <button type="button" className="bg-secondary text-back px-4 py-2 rounded-md" onClick={nextStepHandler}>Submit</button>
        </div>
      </form>
    );
}