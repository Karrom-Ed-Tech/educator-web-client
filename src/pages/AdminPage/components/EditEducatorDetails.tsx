    ...
    <div className="p-page">
      ...
      <div className="my-12 flex flex-col gap-y-5 items-center justify-center">
        ...
        <div className="flex flex-col items-center w-full gap-y-4">
            ...
            <div>
            <input type="text" className="border-2 border-primary rounded-md p-1" value={formData[userDataKey]} onChange={(e) => setFormData({ ...formData, [userDataKey]: e.target.value })} />
      ...
      <button onClick={handleSubmit} className="mt-5 border px-2 py-3 hover:bg-secondary hover:text-white">
        Submit
      </button>
      </div>
    </div>
