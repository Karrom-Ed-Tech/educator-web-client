...
const tableHeader: string[] = ["Name", "id", "Timestamp", "Context"];
const tableData: Array<tableDataProps> = [
  ...
  },
  {
    ...
    timestamp: "12:00PM",
    context:
      "Lorem ipsum dolor sit amet, consect Lorem ipsum dolor sit amet, consect Lorem ipsum dolor sit amet, consect Lorem ipsum dolor sit amet, consect",
  },
];
          ...
          {tableData.map((data, index) => {
            ...
            return (
              <tr key={index}>
                ...
                <td className={classes}>
                  <div className="font-normal">{data.id}</div>
                </td>
                <td className={classes}>
                  <div className="font-normal">{data.timestamp}</div>
                </td>
                <td className={classes}>
                  <div className="font-normal max-w-2xl">{data.context}</div>
                </td>
              </tr>
            );
          })}
